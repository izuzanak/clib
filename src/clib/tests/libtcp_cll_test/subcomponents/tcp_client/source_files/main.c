...
int tcp_comm_s_client_time_event(void *a_tcp_comm,unsigned a_index,epoll_event_s *a_epoll_event,epoll_s *a_epoll)
{/*{{{*/
  (void)a_epoll;
...
int tcp_comm_s_client_fd_event(void *a_tcp_comm,unsigned a_index,epoll_event_s *a_epoll_event,epoll_s *a_epoll)
{/*{{{*/
  tcp_comm_s *this = (tcp_comm_s *)a_tcp_comm;
  tcp_client_s *client = &this->client_list.data[a_index].object;

  if (tcp_conn_s_fd_event(&client->connection,0,a_epoll_event,a_epoll))
  {
