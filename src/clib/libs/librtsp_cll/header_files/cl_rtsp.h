...
typedef int (*rtsp_conn_playing_callback_t)(void *a_object,unsigned a_index,rtsp_play_options_s *a_options);
...
{/*{{{*/
  ...
  this->last_time_stamp = (unsigned)rand() + 1; // NOLINT(cert-msc30-c,cert-msc50-cpp)
