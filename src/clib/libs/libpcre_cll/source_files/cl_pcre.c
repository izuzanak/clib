...
// === methods of structure pcre_s =============================================

int pcre_s_match_n(pcre_s *this,const char *a_data,size_t a_match_cnt,regmatch_array_s *a_matches)
{/*{{{*/
...
int pcre_s_split(pcre_s *this,const string_s *a_src,string_array_s *a_trg)
{/*{{{*/
  debug_assert(*this != NULL);
...
int pcre_s_replace(pcre_s *this,const string_s *a_src,const string_s *a_new,bc_array_s *a_trg)
{/*{{{*/
  debug_assert(*this != NULL);
