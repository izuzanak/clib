...
#define ERROR_VALIDATOR_INVALID_VALUE_VALUE 5
#define ERROR_VALIDATOR_INVALID_PROPERTY_ID 6
#define ERROR_VALIDATOR_INVALID_PROPERTY_REGULAR_EXPRESSION 7
#define ERROR_VALIDATOR_INVALID_REFERENCE_NAME_TYPE 8
#define ERROR_VALIDATOR_INVALID_VALIDATION_ENTRY 9
#define ERROR_VALIDATOR_VALIDATION_ERROR 10
