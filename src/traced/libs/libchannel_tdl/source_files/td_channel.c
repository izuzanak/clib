...
{/*{{{*/
  ...
  // - call callback -
  if (td_channel_s_message_call(this,a_index,td_channel_callback_NEW))
  {
...
{/*{{{*/
  ...
  // - call callback -
  if (td_channel_s_message_call(this,a_index,td_channel_callback_DROP))
  {
    throw_error(TD_CHANNEL_SERVER_CALLBACK_ERROR);
  }
...
{/*{{{*/
  ...
  if (channel_conn_s_fd_event(&this->connection,0,a_epoll_event,a_epoll))
  {
    ...
    {
      // - call callback -
      if (td_channel_client_s_message_call(this,td_channel_callback_DROP))
      {
  ...
  else
  {
    ...
    {
      // - call callback -
      if (td_channel_client_s_message_call(this,td_channel_callback_NEW))
      {
        throw_error(TD_CHANNEL_CLIENT_CALLBACK_ERROR);
      }
    }
